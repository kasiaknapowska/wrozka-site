 ...
 <section className={cubeLinksContainer}>
    ...
    {cubeElements.map(element => (
       <div key={element.name}>
        ...
        {element.name === "Ekstrakcja zębów" && <EkstrakcjaZebowIcon className={cubeIcon}/>}
        {element.name === "Leczenie próchnicy" && <LeczenieProchnicyIcon className={cubeIcon}/>}
        {element.name === "Podcięcie wędzidełka" && <PodciecieWedzidelkaIcon className={cubeIcon}/>}
        {element.name === "Leczenie kanałowe" && <LeczenieKanaloweIcon className={cubeIcon}/>}
        {element.name === "Pierwsza wizyta" && <PierwszaWizytaIcon className={cubeIcon}/>}
        {element.name === "Leczenie w narkozie" && <LeczenieWNarkozieIcon className={cubeIcon}/>}
        {element.name === "Profilaktyka" && <OzonowanieIcon className={cubeIcon}/>}
        {element.name === "Ortodoncja" && <InformacjeDlaPacjentaIcon className={cubeIcon}/>}
