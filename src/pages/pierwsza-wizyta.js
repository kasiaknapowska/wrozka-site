...
const PierwszaWizyta = ({ data, location }) => {
  ...
  return (
    <Layout>
      ...
      <section className="container">
        ...
        <h3>
          {" "}
          Kolorowe wnętrza, bajkowe gabinety, sala zabaw oraz przyjazna
          atmosfera stworzona przez wykwalifikowany personel – to wszystko
          sprawia, że wizyta dziecka jest niesamowitą przygodą a nie przykrym
          obowiązkiem.
        </h3>
        <p>
          ...
          leczenia, zwykle podczas pierwszej wizyty oswajamy dziecko z
          gabinetem, lekarzem, asystentkami. Dziecko ma okazję pobawić się w
          naszej sali zabaw, obejrzeć bajkę, odbyć „przejażdżkę” na fotelu
          dentystycznym. Lekarz przeprowadza badanie zębów w sposób komfortowy i
          bezstresowy dla dziecka. Oprócz oceny zębów doradzamy jak prawidłowo
          dbać o higienę u malucha, jaką szczoteczkę i pastę wybrać, jak często
          należy zgłaszać się na wizyty kontrolne i jakie zabiegi można wykonać,
          by zęby mleczne dotrwały w zdrowiu do czasu ich fizjologicznej
          wymiany.
        </p>
        <ArrowLink
          type="standard"
        ...
        <ol>
          <li>
            <span>
              ...
              wypełnić ankietę medyczną dostępną{" "}
              <a className="textLink" href={data.allFile.edges[0].node.publicURL} target="blank">
                TUTAJ
              </a>
              , którą następnie należy oddać w rejestracji w dzień wizyty. Jeśli
              zechcą Państwo wypełnić ankietę na miejscu – zapraszamy na wizytę
              15 minut wcześniej. Jeśli posiadają Państwo wcześniejszą
              dokumentację medyczną dziecka lub zdjęcia RTG, prosimy o zabranie
              ich ze sobą.
            </span>
          </li>
          <li>
          ...
          <li>
            W dniu wizyty zapraszamy do rejestracji – nasz personel zaopiekuje
            się Państwem oraz wskaże salę zabaw, gdzie dziecko będzie mogło
            przyjemnie spędzić czas w oczekiwaniu na wizytę w gabinecie.
          </li>
          <li>
          ...
          <li>
            ...
            fotelu dentystycznym włączana jest ulubiona bajka. Lekarz
            przeprowadza wywiad z Rodzicem / Opiekunem, zapoznaje dziecko z
            gabinetem i w umiejętny, bezstresowy sposób przeprowadza dokładne
            badanie stanu uzębienia dziecka.
          </li>
          <li>
          ...
          <li>
            Na podstawie planu leczenia umawiane są kolejne wizyty, w dogodnym
            dla Rodziców / Opiekunów terminie. Wizyty można umówić po wizycie w
            rejestracji lub telefonicznie pod numerem {contactData.phone}.
          </li>
          <li>
            W naszym gabinecie akceptujemy płatności gotówką i kartą,
            udostępniamy też możliwość płatności w systemie ratalnym.
          </li>
        </ol>
        <ArrowLink
          type="standard"
...
export const pageQuery = graphql`
  query {
    allFile(filter: { name: { eq: "ankieta_medyczna" } }) {
      edges {
        node {
          publicURL
        }
